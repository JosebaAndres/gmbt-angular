...
import { DeviceType, PHONE_MAX_MEDIA_QUERY_ALIAS, TABLET_MAX_MEDIA_QUERY_ALIAS } from '../../../app/models/device-type';
import {
  LG_MAX_SIZE,
  MD_MAX_SIZE,
  MediaQueryAlias,
  SM_MAX_SIZE,
  XS_MAX_SIZE,
} from '../../../app/models/media-query-alias';
import { NumberFuctions } from '../../../app/models/number';
import {
